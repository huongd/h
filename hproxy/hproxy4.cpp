//		g++ -I/root/h/i -pthread -s -O3 -Os -Wfatal-errors -fpermissive %.cpp -o %.hel ; upx %.hel
...
int main(int argc, char **argv) 
{
	...
	PP( " \tport "<< (argc>1 ? atoi (argv[1]) : 5555))
	if (argc>4){
